...
/*   Updated: 2017/10/27 00:39:30 by jkrause          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** When life gives you Lem_ins, force life to take them back..
** - Joe
**
...
# define FR4_RET(A, B, C, D, E) free(A); free(B); free(C); free(D); return (E);
